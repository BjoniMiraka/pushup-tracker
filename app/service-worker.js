// UPDATE THIS VERSION NUMBER WHENEVER YOU MAKE CHANGES TO YOUR APP
const VERSION = "4.0.0"; // Increment this on each update
const CACHE_NAME = `pushup-tracker-v${VERSION}`;
const urlsToCache = [
  "./pages/index.html",
  "./styles/main.css",
  "./scripts/app.js",
...
self.addEventListener("notificationclick", (event) => {
  ...
  if (event.action === "log") {
    event.waitUntil(clients.openWindow("./pages/index.html"));
  } else {
    event.waitUntil(
